...
<div class="container">
        ...
        <form action="" method="POST">
            ...
            <div class="input-group mb-3">
                <!-- <span class="input-group-text" id="basic-addon1">@</span> -->
                <input type="password" class="form-control" placeholder="Password" id="password" aria-label="Password" name="password" aria-describedby="basic-addon1">
            </div>
